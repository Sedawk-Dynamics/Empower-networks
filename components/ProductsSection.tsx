...
function AnimatedHeading({ text, className = '' }: { text: string; className?: string }) {
  ...
  return (
    <h2 ref={ref} className={`font-heading font-black leading-tight text-balance ${className}`}>
...
export default function ProductsSection() {
  ...
  return (
    <section id="products" className="relative overflow-hidden bg-[#FAF9F7] py-24 lg:py-32">
      {/* Background glow */}
      <div className="pointer-events-none absolute right-0 top-0 h-[320px] w-[520px] rounded-full bg-[#E31E24]/6 blur-[140px]" />
      <div className="pointer-events-none absolute bottom-0 left-0 h-[280px] w-[420px] rounded-full bg-[#C9A84C]/10 blur-[120px]" />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <p className="mt-3 max-w-md text-sm leading-relaxed text-gray-500">
              Click any product to enquire — we handle sourcing, logistics and documentation
              end-to-end.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            <button
              onClick={scrollPrev}
              aria-label="Previous"
              className="flex h-11 w-11 items-center justify-center rounded-full border border-black/10 bg-white text-gray-500 shadow-sm transition-all duration-300 hover:border-[#E31E24]/60 hover:bg-[#E31E24]/10 hover:text-[#E31E24]"
            >
              <ChevronLeft size={20} />
            </button>
            <button
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className="group flex h-full min-h-[760px] flex-col overflow-hidden rounded-[28px] border border-black/[0.06] bg-white shadow-soft transition-all duration-500 hover:-translate-y-2 hover:border-[#E31E24]/30 hover:shadow-[0_24px_60px_rgba(227,30,36,0.18)]"
                  >
                    {/* Image */}
                    <div className="relative h-56 flex-shrink-0 overflow-hidden">
                      ...
                      {/* Icon */}
                      <div className="absolute left-4 top-4 flex h-11 w-11 items-center justify-center rounded-2xl border border-white/40 bg-white/80 backdrop-blur-xl">
                        <Icon size={18} className="text-[#E31E24]" />
                      </div>

                      {/* Badge */}
                      <div className="absolute right-4 top-4 rounded-full border border-white/40 bg-white/85 px-3 py-1 backdrop-blur-xl">
                    ...
                    <div className="flex flex-1 flex-col p-6">
                      ...
                      <div className="mb-6 grid flex-1 auto-rows-fr grid-cols-2 gap-3">
                        {cat.items.map((item) => {
                          const isImportExport = item.tag === 'Import & Export'
                          const isImport = item.tag === 'Import'
                          ...
                          return (
                            ...
                            >
                              <motion.div
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="flex min-h-[62px] w-full items-center justify-center rounded-[24px] border px-4 py-3 text-center text-sm font-semibold leading-tight transition-all duration-300 hover:shadow-md"
                                style={{
                                  background: isImportExport
                                    ? 'rgba(227,30,36,0.08)'
                                    : isImport
                                      ? 'rgba(59,130,246,0.08)'
                                      : 'rgba(34,197,94,0.08)',
                                  borderColor: isImportExport
                                    ? 'rgba(227,30,36,0.30)'
                                    : isImport
                                      ? 'rgba(59,130,246,0.30)'
                                      : 'rgba(34,197,94,0.28)',
                                  color: isImportExport
                                    ? '#c01a1f'
                                    : isImport
                                      ? '#1d4ed8'
                                      : '#15803d',
                      ...
                      {/* Premium CTA */}
                      <Link href="/contact" className="group relative mt-auto overflow-hidden rounded-2xl">
        ...
        >
          <div className="mx-auto max-w-2xl rounded-[32px] border border-black/[0.06] bg-white p-8 shadow-soft">
