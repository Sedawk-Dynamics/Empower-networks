  ...
  return (
    <section className="relative bg-[#0F0F0F] py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[800px] h-[400px] bg-[#E31E24]/3 blur-[100px] rounded-full" />
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="relative bg-[#131313] border border-white/5 rounded-3xl p-8 sm:p-12 overflow-hidden"
        >
          {/* Red corner accent */}
          <div className="absolute top-0 left-0 w-32 h-32 bg-[#E31E24]/8 blur-2xl rounded-full -translate-x-8 -translate-y-8" />
          <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#E31E24]/5 blur-3xl rounded-full translate-x-12 translate-y-12" />
          ...
          <blockquote className="relative z-10 text-center">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className="flex-1 max-w-[80px] h-[1px] bg-white/10" />
