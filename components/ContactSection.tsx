...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative bg-[#080808] py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-[#E31E24]/4 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-10">
            ...
            {contactInfo.map((item, i) => {
              ...
              const content = (
                <motion.div
                  ...
                  className="group flex items-start gap-4 p-5 bg-[#0F0F0F] border border-white/5 rounded-2xl hover:border-[#E31E24]/30 hover:bg-[#131313] transition-all duration-300 hover:-translate-x-1"
                >
                  ...
                  <div>
                    <p className="text-xs font-bold text-white/40 tracking-wider uppercase mb-1">{item.label}</p>
                    <p className="text-white/80 text-sm leading-relaxed group-hover:text-white transition-colors">{item.value}</p>
                  </div>
                </motion.div>
              )
          ...
          <motion.div
            ...
            className="bg-[#0F0F0F] border border-white/5 rounded-2xl p-7 sm:p-8"
          >
            <div className="flex items-center gap-2 mb-6">
              <Send size={18} className="text-[#E31E24]" />
              <h3 className="font-heading text-lg font-bold text-white">Send an Enquiry</h3>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#131313] border border-white/8 rounded-xl px-4 py-3 text-white/80 placeholder-white/25 text-sm focus:outline-none focus:border-[#E31E24]/50 focus:bg-[#1a1a1a] transition-all"
                    />
                  </div>
                  <div>
                    <label className="text-xs text-white/40 font-semibold tracking-wider uppercase block mb-1.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#131313] border border-white/8 rounded-xl px-4 py-3 text-white/80 placeholder-white/25 text-sm focus:outline-none focus:border-[#E31E24]/50 focus:bg-[#1a1a1a] transition-all resize-none"
                  />
                </div>
                <button
                  type="submit"
